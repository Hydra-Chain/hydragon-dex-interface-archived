...
const CHAIN_INFO: ChainInfoMap = {
  ...
  [SupportedChainId.OPTIMISM]: {
    ...
    infoLink: 'https://info.hydradex.org/#/optimism/',
    label: 'Optimism',
    logoUrl: optimismLogoUrl,
    // Optimism perfers same icon for both
    circleLogoUrl: optimismLogoUrl,
    statusPage: 'https://optimism.io/status',
    helpCenterUrl: 'https://help.hydradex.org/en/collections/3137778-hydradex-on-optimistic-ethereum-oξ',
  ...
  [SupportedChainId.ARBITRUM_ONE]: {
    ...
    infoLink: 'https://info.hydradex.org/#/arbitrum',
    label: 'Arbitrum',
    logoUrl: arbitrumLogoUrl,
    circleLogoUrl: arbitrumCircleLogoUrl,
    defaultListUrl: ARBITRUM_LIST,
    helpCenterUrl: 'https://help.hydradex.org/en/collections/3137787-hydradex-on-arbitrum',
    nativeCurrency: { name: 'Ether', symbol: 'ETH', decimals: 18 },
  ...
  [SupportedChainId.POLYGON]: {
    ...
    infoLink: 'https://info.hydradex.org/#/polygon/',
    label: 'Polygon',
  ...
  [SupportedChainId.CELO]: {
    ...
    infoLink: 'https://info.hydradex.org/#/celo',
    label: 'Celo',
    logoUrl: celoLogo,
