...
// Hydra Chain
const HYDRACHAIN_V2_CORE_FACTORY_ADDRESSES = ''
const HYDRACHAIN_V2_ROUTER_ADDRESSES = ''

const HYDRACHAIN_V3_CORE_FACTORY_ADDRESSES = ''
const HYDRACHAIN_MULTICALL_ADDRESS = ''
const HYDRACHAIN_TICK_LENS_ADDRESSES = ''

const HYDRACHAIN_SWAP_ROUTER_ADDRESSES = '' // Router 02 from swap-router-contracts
const HYDRACHAIN_V3_MIGRATOR_ADDRESSES = ''
const HYDRACHAIN_NONFUNGIBLE_POSITION_MANAGER_ADDRESSES = ''
const HYDRACHAIN_QUOTER_ADDRESSES = ''
